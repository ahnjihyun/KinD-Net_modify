...
#the input of decomposition netp
input_decom = tf.compat.v1.placeholder(tf.float32, [None, 400, 600, 3], name='input_decom')
#the input of illumination adjustment net
input_low_i = tf.compat.v1.placeholder(tf.float32, [None, 48, 48, 1], name='input_low_i')
input_low_i_ratio = tf.compat.v1.placeholder (tf.float32, [None, 48, 48, 1], name='input_low_i_ratio')
input_high_i = tf.compat.v1.placeholder(tf.float32, [None, 48, 48, 1], name='input_high_i')
